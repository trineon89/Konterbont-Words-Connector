    ...
    public partial class frmMain : Form
    {
        ...
        */
        ...
        private void btnCustomAudio_Click(object sender, EventArgs e)
        {
            ...
            {
                globaldt.WordList[lbWords.SelectedIndex].Wierder[lbSelectWord.SelectedIndex].Meanings[lbSelectMeaning.SelectedIndex].MP3 = Path.GetFileName(fileDialog.FileName);
