...
var theFileName = app.activeDocument.name.substr(0, 4);
...
function createbutton(GB, _theSpread, _theButtonName, _pageSel, _count) {
    ...
    if (_pageSel == "P") {
        ...
        var myProperties = {
            'woUrl': 'webresource://popupbase-web-resources/' + theFileName + '_popups.html?word=' + deUmlaut(_theButtonName),
...
function deUmlaut(value) {
    var encodedval = encodeURI(value);
    return encodedval;
}

function savewords() {
    myFile = File(app.activeDocument.filePath + "/../color.export");
